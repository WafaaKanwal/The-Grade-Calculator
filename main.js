...
inquirer.prompt([
    ...
    if (percentage >= 90 && percentage <= 100) {
        gradeDescription = chalk.blueBright.bold("\t\t\t xcellent! You've achieved Grade A1.");
    }
    else if (percentage >= 80) {
        gradeDescription = chalk.blueBright.bold("\t\t\tWell done! Your Grade is A+.");
    }
    else if (percentage >= 70) {
        gradeDescription = chalk.blueBright.bold("\t\t\tGood job! Your Grade is A.");
    }
    else if (percentage >= 60) {
        gradeDescription = chalk.blueBright.bold("\t\t\tNicely done! Your Grade is B.");
    }
    else if (percentage >= 50) {
        gradeDescription = chalk.blueBright.bold("\t\t\tYou've passed with Grade C.");
    }
    else if (percentage >= 40) {
        gradeDescription = chalk.blueBright.bold("\t\t\tYou've passed.");
    }
    else {
        gradeDescription = chalk.redBright.bold("\t\t\tUnfortunately, you did not pass.");
    }
